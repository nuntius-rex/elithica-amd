 ...
 *modified by Dan Guinn, 2018-09-25
 *	converted to AMD
 *  sort disable feature (if header has class "nosort")
*/
						...
						if(! $(this).hasClass("nosort")){
					        ...
					        $("<img>") // create image that allows you to sort by specific column
					            ...
					            .on('click', function(){
													...
													$('table tr.GRIDnestedRow').remove(); //DWG, remove nested when sorting
					                ...
					                var rows = $("tr", $destElement)
													.not(":has(th)").get(); // save all rows (tr) into array (.get())
